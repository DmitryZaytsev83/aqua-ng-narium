...
export class PhotosComponent implements OnInit {
  photos = [
    ...
    {id: 4, src: 'assets/gallery/11.jpg'},
    {id: 5, src: 'assets/gallery/4.jpg'},
    ...
    {id: 11, src: 'assets/gallery/10.jpg'},
    {id: 12, src: 'assets/gallery/14.jpg'},
    {id: 13, src: 'assets/gallery/12.jpg'},
    {id: 14, src: 'assets/gallery/13.jpg'},
  ];
